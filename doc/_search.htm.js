...
Keyword = 
[
'cppad_py  cppad_py-20180713: A C++ AD Library with a Swig Interface  ',' purpose under construction getting started function speed supporting packages required top source directory license contents ',
...
'py_a_fun_property  Properties of an AD Function  ',' syntax af size_domain size_range size_var size_op example ',
...
'cpp_a_fun_property  Properties of an AD Function  ',' syntax af size_domain size_range size_var size_op example ',
...
'sparse_rc  Sparsity Patterns  ',' syntax nr nc nnz resize put k row col row_major col_major example ',
'sparse_rcv  Sparse Matrices  ',' syntax pattern matrix nr nc nnz put k row col val row_major col_major example ',
...
'sparse_jac  Computing Sparse Jacobians  ',' syntax purpose sparse_jac_for sparse_jac_rev af subset pattern work n_sweep uses forward example ',
'sparse_hes  Computing Sparse Hessians  ',' syntax purpose af subset pattern work n_sweep uses forward example ',
...
'whats_new_2018  Cppad Py Changes During 2018  ',' 07-13 07-12 07-10 07-08 07-07 07-03 '
]
